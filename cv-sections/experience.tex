...
\item {Created an automatic deployment of Hadoop and Spark standalone cluster script on DockerHub with 300+ downloads.}
\item {Lectured Hadoop, Spark and Docker deployment and usage for over 40 graduate students in Financial Investing and Trading Program.}
\end{cvitems}
}
