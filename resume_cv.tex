...
\geometry{left=1.8cm, top=1.2cm, right=1.8cm, bottom=1.5cm, footskip=.5cm} % Configure page margins with geometry
...
\name{Hsuan-Ming}{Chen}
\address{New Taipei City 220, Taiwan}
\mobile{(+886) 987-817-857}
...
%\xing{xing name}
%\extrainfo{DockerHub: chming1016} % Other text you want to include on this line

\position{Security Researcher{\enskip\cdotp\enskip}Software Engineer} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{Last Updated on \today}{Hsuan-Ming Chen~~~·~~~Résumé}{}%{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
