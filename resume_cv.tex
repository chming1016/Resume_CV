...
%\xing{xing name}
%\extrainfo{chming1016} % Other text you want to include on this line
%\extrainfo{DockerHub: chming1016}

\position{IT Security{\enskip\cdotp\enskip}Machine Learning{\enskip\cdotp\enskip}Cloud Computing} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Hsuan-Ming Chen~~~·~~~Résumé}{}%{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
